...
const WatchListProduct = () => {
    ...
    return (
        <div className=' p-5 min-h-screen'>
            ...
            {wishList && wishList.length === 0 && <div className='text-xl md:text-2xl font-semibold text-gray-700 h-[70vh] flex flex-col gap-3 justify-center items-center'>
            ...
            {wishList && wishList.length > 0 && <div>
                <div className=' flex max-[480px]:flex-col justify-between'>
                    <h1 className=' text-3xl font-semibold text-gray-700'>Your WishList</h1>
                ...
                <div className=' grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 py-5'>
                    {wishList.map((product, i) => (<div className=' flex flex-col rounded-md bg-gray-300 p-4 gap-4 ' key={i}>
                        ...
                        <Link to={`/product/${product._id}`} className=' text-xl font-semibold text-gray-700 hover:text-blue-600 transition-all duration-300 hover:underline'>{product.title.length > 100 ? product.title.slice(0, 100) + "..." : product.title}</Link>
