...
const SalesmanProducts = () => {
    ...
    return (
        <div className=' min-h-screen p-5'>
            ...
            {products && products.length === 0 && <div className=' text-2xl md:text-3xl font-semibold text-gray-700 h-[80vh] flex flex-col justify-center items-center'>
            ...
            {products && products.length > 0 && <div>
                ...
                <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 py-5  '>
                    {products.map((product, i) => (
                        <div className=' bg-gray-50 shadow-md shadow-gray-400 rounded-md px-3 lg:px-2'>
                            <div className=' px-1 '>
                                <div className=' flex flex-col md:flex-row py-2 '>
                                    ...
                                    <div className=' lg:px-4 px-2'>
                                        <div className=' text-md font-semibold'>
                                            Id: <span className=' text-md font-semibold text-gray-600'>{product._id}</span>
                                        </div>
                                        <div className=' text-md font-semibold'>
                                            Price: <span className=' text-md font-semibold text-gray-600'>&#8377; {product.price}</span>
                                        </div>
                                        <div className=' text-md font-semibold'>
                                            Post Date: <span className=' text-md font-semibold text-gray-600'>{formatDate(product.createdAt)}</span>
                                        </div>
                            ...
                            <Link to={`/product/${product._id}`} className=' px-2 text-gray-700 font-semibold hover:text-blue-500 transition-all duration-300 hover:underline cursor-pointer '>
                                <p>{product.title}</p>
                            </Link>
                        </div>
                    ))}
