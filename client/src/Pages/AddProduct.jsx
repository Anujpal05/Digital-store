...
const AddProduct = () => {
    ...
    return (
        <div className=' min-h-screen '>
            <div className=' flex justify-center items-center min-h-[90vh] pt-5 '>
                <form action="" className=' flex flex-col justify-center items-center h-fit w-[90%] md:w-fit p-5 rounded-md  gap-4 bg-gray-100  shadow-md shadow-black  ' onSubmit={addNewProduct}>
