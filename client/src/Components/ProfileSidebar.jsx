            ...
            <div className={` h-screen md:w-96 w-screen fixed right-0 bg-gray-600 py-16 dark:bg-gray-700 z-20 transition-transform duration-700 ease-in-out ${isVisible ? "translate-x-0" : "translate-x-full"} `}>
                ...
                {user && <div className=' flex flex-col justify-center items-center py-5 gap-5'>
                    ...
                    <div className=' text-xl font-semibold text-gray-700 bg-blue-400 rounded-md p-2 w-60 text-center' onClick={() => setisVisible(!isVisible)}>
                        <Link to={"/user-details"} className=' flex items-center justify-center w-full text-gray-700 gap-1 outline-none'><span className=' text-blue-700 '><MdEdit /></span>Edit</Link>
                    </div>
